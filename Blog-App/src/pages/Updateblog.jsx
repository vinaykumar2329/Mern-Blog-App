  ...
  return (
    <div className='text-center  flex flex-col h-[90vh] justify-center items-center gap-3 bg-[url("https://plus.unsplash.com/premium_photo-1674834298045-e405bc99076b?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NXx8Y2xvdWR8ZW58MHx8MHx8fDA%3D")] bg-cover bg-center'>
      ...
      <form  className='flex flex-col gap-2 w-100 text-start' onSubmit={handleSubmit}>
        ...
        <input className='border-gray-500 border-2 px-3 py-2 rounded-2xl'  type="text" name="title" value={inputs.title} onChange={handleChange} />

        <label htmlFor="email" className='font-bold'>Email</label>
        <input className='border-gray-500 border-2 px-3 py-2 rounded-2xl' type="text" name="content" value={inputs.content} onChange={handleChange} />

        <label htmlFor="password" className='font-bold'>Password</label>
        <input className='border-gray-500 border-2 px-3 py-2 rounded-2xl' type='url' name="image" value={inputs.image} onChange={handleChange} />
